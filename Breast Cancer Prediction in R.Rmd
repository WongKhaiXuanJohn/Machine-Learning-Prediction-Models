...
```{r}
dat <- read.csv("C:/Users/User/Desktop/APU's Documents/MSc Data Science & Business Analytics/Semester 1/Applied Machine Learning/Assignments/Datasets/Breast_cancer_data (use this).csv")
```
